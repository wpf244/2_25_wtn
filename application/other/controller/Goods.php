...
use app\other\model\Goods as GoodsModel;
...
class Goods extends BaseAdmin{
    ...
    public function lister(){
        ...
        $list=db('goods')->alias('a')->where(["g_audi"=>1,"shopid"=>$uid])->join("type b","a.fid = b.type_id")->order(['g_sort'=> 'asc','gid'=>'desc'])->paginate(20);
        $this->assign("list",$list);
    ...
    public function index(){
        ...
        $list=db('goods')->alias('a')->where(["g_audi"=>0,"shopid"=>$uid])->join("type b","a.fid = b.type_id")->order(['g_sort'=> 'asc','gid'=>'desc'])->paginate(20);
        $this->assign("list",$list);
